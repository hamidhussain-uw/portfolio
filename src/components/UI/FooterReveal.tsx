	...
	return (
		...
		>
			<div className="mx-auto max-w-design-content px-5 py-7 sm:px-6 sm:py-8 md:py-9">
				...
				<motion.div
					variants={item}
					className="mt-6 flex flex-col items-center justify-between gap-2 border-t border-slate-200/80 pt-4 text-center text-[11px] text-slate-500 sm:flex-row sm:gap-3 sm:text-left sm:text-xs"
				>
					<p>
